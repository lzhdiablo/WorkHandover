 ...
 */
package com.dingjust.platform.klotho.core.constants;

/**
 * Global class for all DjklothoCore constants. You can add global constants for your extension into this class.
 */
public final class DjklothoCoreConstants extends GeneratedDjklothoCoreConstants
{
	public static final String EXTENSIONNAME = "djklothocore";


	private DjklothoCoreConstants()
	{
		//empty
	}
