 ...
 */
package com.dingjust.platform.klotho.platformws.controllers;

import com.dingjust.platform.klotho.platformws.data.UserData;
import com.dingjust.platform.klotho.platformws.data.UserDataList;
import com.dingjust.platform.klotho.platformws.dto.*;
import com.dingjust.platform.klotho.platformws.facades.SampleFacades;
...
import static com.dingjust.platform.klotho.platformws.constants.DjklothoplatformwsConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static com.dingjust.platform.klotho.platformws.constants.DjklothoplatformwsConstants.PASSWORD_AUTHORIZATION_NAME;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/djklothoplatformws/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/djklothoplatformws/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/djklothoplatformws/sample/users
	 * <li>http://localhost:9001/djklothoplatformws/sample/users?fields=users(info)
	 * <li>http://localhost:9001/djklothoplatformws/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/djklothoplatformws/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/djklothoplatformws/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/djklothoplatformws/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/djklothoplatformws/sample/usersPaged
	 * <li>http://localhost:9001/djklothoplatformws/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/djklothoplatformws/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/djklothoplatformws/sample/users/user1
	 * <li>http://localhost:9001/djklothoplatformws/sample/users/user1?fields=info
	 * <li>http://localhost:9001/djklothoplatformws/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/djklothoplatformws/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/djklothoplatformws/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/djklothoplatformws/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 *
	 * Url: http://localhost:9001/djklothoplatformws/sample/map
	 *
	 */
