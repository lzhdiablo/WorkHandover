...
/**
 * This is the extension manager of the Djklothostorefront extension.
 */
public class DjklothostorefrontManager extends GeneratedDjklothostorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(DjklothostorefrontManager.class);
	 ...
	 */
	public static DjklothostorefrontManager getInstance()
	{
		return (DjklothostorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DjklothostorefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DjklothostorefrontManager() // NOPMD 
	{
		LOG.debug("constructor of DjklothostorefrontManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of DjklothostorefrontManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of DjklothostorefrontManager called, current tenant: {}", getTenant().getTenantID());
	}
