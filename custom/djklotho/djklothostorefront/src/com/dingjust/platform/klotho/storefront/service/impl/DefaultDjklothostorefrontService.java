 ...
 */
package com.dingjust.platform.klotho.storefront.service.impl;
...
public class DefaultDjklothostorefrontService implements DjklothostorefrontService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDjklothostorefrontService.class);
	...
	{
		return DefaultDjklothostorefrontService.class.getResourceAsStream("/djklothostorefront/sap-hybris-platform.png");
	}
