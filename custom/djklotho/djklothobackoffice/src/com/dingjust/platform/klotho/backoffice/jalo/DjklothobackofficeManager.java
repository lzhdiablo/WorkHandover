 ...
 */
package com.dingjust.platform.klotho.backoffice.jalo;
...
import com.dingjust.platform.klotho.backoffice.constants.DjklothobackofficeConstants;
 ...
 */
public class DjklothobackofficeManager extends GeneratedDjklothobackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DjklothobackofficeManager.class.getName());
	 ...
	 */
	public static DjklothobackofficeManager getInstance()
	{
		return (DjklothobackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DjklothobackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DjklothobackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DjklothobackofficeManager called.");
		}
	}
